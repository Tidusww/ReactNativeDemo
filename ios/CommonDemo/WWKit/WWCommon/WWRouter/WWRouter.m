...
#pragma mark - 获取TabBarController 和 NavigationController
+ (WWBaseTabBarController *)rootTabBarController
{
    WWBaseAppDelegate *delegate = [WWBaseAppDelegate sharedAppDelegate];
    WWBaseTabBarController *tabBarController = [delegate tabBarController];
    return tabBarController;
}

+ (WWBaseNavigationController *)topNavigationController
{
    WWBaseAppDelegate *delegate = [WWBaseAppDelegate sharedAppDelegate];
    WWBaseNavigationController *navigationController = [delegate navigationViewController];
...
{
    WWBaseNavigationController *navigationController = [self topNavigationController];
