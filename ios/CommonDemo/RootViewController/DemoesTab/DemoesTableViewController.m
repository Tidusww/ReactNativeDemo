...
#import "DemoesTableViewController.h"
#import "WWFoldable.h"
...
@interface DemoesTableViewController () <UITableViewDataSource, UITableViewDelegate>
...
@implementation DemoesTableViewController
...
{
    self.tableView.frame = CGRectMake(0, 0, SCREEN_WIDTH, self.rootViewHeight);
}
...
{
    if(!_tableView){
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, self.rootViewHeight)];
